...
usuario = "gabriel.naato@gmail.com"
dir_path = os.getcwd()
...
def bot():
    try:
        ...
        #RESPONDENDO CLIENTE
        resposta = requests.get('http://localhost/VALMIR/index.php?', params={'msg': msg, 'telefone': telefone_final, '  usuario': usuario}, headers=agent)
        time.sleep(1)
